...
public class HomBCore {
	...
	public HomBCore(int graph[][], int vertexType[], int edgeType[]) {
		this.graph = graph;
	...
	//this function was added for doing experiments
	public Map<Integer, Set<Integer>> buildHomGraph(MetaPath queryMPath) {
		this.queryMPath = queryMPath;
		return buildGraph();
	}
