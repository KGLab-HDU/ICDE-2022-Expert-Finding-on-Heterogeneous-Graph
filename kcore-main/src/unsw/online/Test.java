...
import unsw.online.edgeDisjoint.LazyECore;
import unsw.util.LazyECore2;
...
//				queryId = 111516;
				...
				LazyECore mfeCore = new LazyECore(graph, vertexType, edgeType);
				Set<Integer> rsSet1 = mfeCore.query(queryId, queryMPath, queryK);
				long t2 = System.nanoTime();
				if(rsSet1 != null)  System.out.println("|rsSet1|=" + rsSet1.size() + " time:" + (t2 - t1));
				else System.out.println("rsSet1 is empty");
				
				LazyECore2 gdeCore = new LazyECore2(graph, vertexType, edgeType);
				Set<Integer> rsSet2 = gdeCore.query(queryId, queryMPath, queryK);
