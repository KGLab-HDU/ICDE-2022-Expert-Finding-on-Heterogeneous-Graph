...
public class LazyVCoreDecomposition implements Decomposition{
	...
	public LazyVCoreDecomposition(int[][] graph , int[] vertexType , int[] edgeType) {
		this.graph = graph;
	...
	public Map<Integer, Integer> decompose(MetaPath queryMPath) {
		...
		while (curCoreNum < keepSet.size()) {
			...
			while (!removeQueue.isEmpty()) {
				...
				int exactDegree = vMaxFlow.obtainVDegree(removeId, keepSet, null);
